...
void SoftmaxUnknownWithLossLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void SoftmaxUnknownWithLossLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SoftmaxUnknownWithLossLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SoftmaxUnknownWithLossLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(SoftmaxUnknownWithLossLayer);
#endif

INSTANTIATE_CLASS(SoftmaxUnknownWithLossLayer);
REGISTER_LAYER_CLASS(SoftmaxUnknownWithLoss);
